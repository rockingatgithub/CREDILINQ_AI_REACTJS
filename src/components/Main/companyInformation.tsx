    ...
    return (
        ...
        >
            <TextField
                ...
                label="Company UEN"
                helperText={companyUENError ? "Company UEN is required, and length must equal or be more than 8 characters" : null}
                value={companyUEN}
            ...
            <TextField
                ...
                label="Company Name"
                helperText={companyNameError ? "Company Name is required, and length must equal or be more than 8 characters" : null}
                value={companyName}
